...
public class AladdinOpenAPI {
	...
	public static void main(String[] args) throws Exception {
		String url = GetUrl("java");
		AladdinOpenAPIHandler api = new AladdinOpenAPIHandler();
		api.parseXml(url);
		RestTemplate restTemplate = new RestTemplate();
		//https://endmemories.tistory.com/9
		//org.xml.sax.SAXParseException; lineNumber: 1; columNumber: 3721;  요소 유형 HR은(는) 짝이 맞는 종료 태그 "</HR>"(으)로 종료되어야 합니다.
